...
!!! info "Зміни від 01.01.2026"
    З 1 січня 2026 року скасовуються тимчасові правила для осіб з тимчасовим колективним захистом. Це означає, що ця група отримає **право та обов'язок** брати участь в інтродукційній програмі, а можливість муніципалітетів пропонувати програму на неповний робочий день буде скасована.
    
    - **Для осіб з освітою на рівні середньої школи або вище:** максимальна тривалість програми становитиме до 12 місяців без можливості продовження. Для програм, спрямованих на працевлаштування, з четвертого місяця мінімум 15 годин на тиждень повинні складати елементи, пов'язані з роботою.
    - **Для осіб без освіти на рівні середньої школи:** максимальна тривалість програми для тих, хто прагне отримати роботу, становитиме до двох років без можливості продовження. Для програм, спрямованих на працевлаштування, з сьомого місяця мінімум 15 годин на тиждень повинні складати елементи, пов'язані з роботою.
    - **Розширення вікових меж (дата не визначена):** У майбутньому планується розширити вікові рамки для участі в програмі до 60 років.

Особи віком від 18 до 55 років, що користуються тимчасовим колективним захистом та проживають у муніципалітеті за договором з органам інтеграції IMDI, за власним бажанням, мають право на ознайомлювальну програму. (Правила до 01.01.2026)
...
[Інформація про ознайомлювальну програму та вивчення мови (для тих хто отримав тимчасовий колективний захист) від Директорату з інтеграції та культурно-етнічного різноманіття (IMDI)](https://arkiv.imdi.no/globalassets/dokumenter/velkommet-til-introduksjonsprogrammet-20211/imdi_introduksjonsbrosjyre_ukrainsk.pdf)
...
Якщо ви бажаєте дізнатися детальніше про юридичний контекст до інтродукційної програми, то ви можете переглянути [юридичний посібник до закону про інтеграцію, розділ 6А (норвезькою)](https://www.imdi.no/regelverk/integreringsloven/veileder-til-integreringsloven/8.-midlertidige-regler-for-personer-som-har-fatt-oppholdstillatelse-etter-utlendingsloven--34). Інформація про тривалість програми описується під пунктом _8.5.9 Varighet og sluttmål for introduksjonsprogram_. Детальніше про зміни можна прочитати на [сайті IMDI](https://www.imdi.no/aktuelt/nyheter/endringer-i-integreringsregelverket/).
